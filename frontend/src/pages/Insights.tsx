  ...
  return (
    <div className="space-y-8 pb-8">
      <div className="bg-gradient-to-r from-slate-800 to-slate-900 text-white p-8 rounded-xl shadow-lg">
        <h1 className="text-4xl font-bold mb-2">SalesSync Data Insights</h1>
        <p className="text-slate-300 text-lg">Comprehensive analysis and performance summary</p>
        <p className="text-slate-400 text-sm mt-2">Data period: September 2025 - February 2026</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white border-0 shadow-lg">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-emerald-100 text-sm font-medium">Total Checkins</p>
                <p className="text-4xl font-bold mt-2">{kpis?.total_checkins?.toLocaleString() || 0}</p>
              </div>
              <CheckCircle className="h-14 w-14 text-emerald-200 opacity-80" />
            </div>
            <div className="mt-4 flex items-center gap-2 text-emerald-100">
              <ArrowUp className="h-4 w-4" />
              <span className="text-sm">{approvalRate}% approval rate</span>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold mt-2">{kpis?.active_agents || 0}</p>
              </div>
              <Users className="h-14 w-14 text-blue-200 opacity-80" />
            </div>
            <div className="mt-4 flex items-center gap-2 text-blue-100">
              <Zap className="h-4 w-4" />
              <span className="text-sm">{avgCheckinsPerAgent} avg checkins/agent</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-amber-500 to-amber-600 text-white border-0 shadow-lg">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-amber-100 text-sm font-medium">Total Shops</p>
                <p className="text-4xl font-bold mt-2">{kpis?.total_shops?.toLocaleString() || 0}</p>
              </div>
              <Store className="h-14 w-14 text-amber-200 opacity-80" />
            </div>
            <div className="mt-4 flex items-center gap-2 text-amber-100">
              <MapPin className="h-4 w-4" />
              <span className="text-sm">Registered locations</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white border-0 shadow-lg">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <Target className="h-14 w-14 text-purple-200 opacity-80" />
            </div>
            <div className="mt-4 flex items-center gap-2 text-purple-100">
              <UserCheck className="h-4 w-4" />
              <span className="text-sm">{kpis?.conversions?.toLocaleString() || 0} conversions</span>
            </div>
          </CardContent>
        </Card>
      </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-emerald-800">Peak Hour</span>
                </div>
                <p className="text-3xl font-bold text-emerald-600">{peakHour.hour}:00</p>
                <p className="text-sm text-emerald-600 mt-1">{peakHour.count.toLocaleString()} checkins</p>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-slate-200 rounded-full h-3">
                  <div className="bg-emerald-500 h-3 rounded-full transition-all" style={{ width: `${approvalRate}%` }}></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-slate-200 rounded-full h-3">
                  <div className="bg-purple-500 h-3 rounded-full transition-all" style={{ width: `${conversionRate}%` }}></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-slate-200 rounded-full h-3">
                  <div className="bg-amber-500 h-3 rounded-full transition-all" style={{ width: `${newToBettingRate}%` }}></div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-4 bg-slate-700/50 rounded-xl">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-semibold text-emerald-400">Peak Activity</h4>
              </div>
